...
const { t } = useI18n()
const info = reactive({
  title: "tools.ascii.title",
})
// ascii: https://ascii.co.uk/table
const tableDataControlCodes = computed(() => [
  { dec: "0", oct: "000", hex: "0", code: "NUL", desc: t('tools.ascii.codes.0') },
  { dec: "1", oct: "001", hex: "1", code: "SOH", desc: t('tools.ascii.codes.1') },
  { dec: "2", oct: "002", hex: "2", code: "STX", desc: t('tools.ascii.codes.2') },
  { dec: "3", oct: "003", hex: "3", code: "ETX", desc: t('tools.ascii.codes.3') },
  { dec: "4", oct: "004", hex: "4", code: "EOT", desc: t('tools.ascii.codes.4') },
  { dec: "5", oct: "005", hex: "5", code: "ENQ", desc: t('tools.ascii.codes.5') },
  { dec: "6", oct: "006", hex: "6", code: "ACK", desc: t('tools.ascii.codes.6') },
  { dec: "7", oct: "007", hex: "7", code: "BEL", desc: t('tools.ascii.codes.7') },
  { dec: "8", oct: "010", hex: "8", code: "BS", desc: t('tools.ascii.codes.8') },
  { dec: "9", oct: "011", hex: "9", code: "HT", desc: t('tools.ascii.codes.9') },
  { dec: "10", oct: "012", hex: "A", code: "LF", desc: t('tools.ascii.codes.10') },
  { dec: "11", oct: "013", hex: "B", code: "VT", desc: t('tools.ascii.codes.11') },
  { dec: "12", oct: "014", hex: "C", code: "FF", desc: t('tools.ascii.codes.12') },
  { dec: "13", oct: "015", hex: "D", code: "CR", desc: t('tools.ascii.codes.13') },
  { dec: "14", oct: "016", hex: "E", code: "SO", desc: t('tools.ascii.codes.14') },
  { dec: "15", oct: "017", hex: "F", code: "SI", desc: t('tools.ascii.codes.15') },
  { dec: "16", oct: "020", hex: "10", code: "DLE", desc: t('tools.ascii.codes.16') },
  { dec: "17", oct: "021", hex: "11", code: "DC1", desc: t('tools.ascii.codes.17') },
  { dec: "18", oct: "022", hex: "12", code: "DC2", desc: t('tools.ascii.codes.18') },
  { dec: "19", oct: "023", hex: "13", code: "DC3", desc: t('tools.ascii.codes.19') },
  { dec: "20", oct: "024", hex: "14", code: "DC4", desc: t('tools.ascii.codes.20') },
  { dec: "21", oct: "025", hex: "15", code: "NAK", desc: t('tools.ascii.codes.21') },
  { dec: "22", oct: "026", hex: "16", code: "SYN", desc: t('tools.ascii.codes.22') },
  { dec: "23", oct: "027", hex: "17", code: "ETB", desc: t('tools.ascii.codes.23') },
  { dec: "24", oct: "030", hex: "18", code: "CAN", desc: t('tools.ascii.codes.24') },
  { dec: "25", oct: "031", hex: "19", code: "EM", desc: t('tools.ascii.codes.25') },
  { dec: "26", oct: "032", hex: "1A", code: "SUB", desc: t('tools.ascii.codes.26') },
  { dec: "27", oct: "033", hex: "1B", code: "ESC", desc: t('tools.ascii.codes.27') },
  { dec: "28", oct: "034", hex: "1C", code: "FS", desc: t('tools.ascii.codes.28') },
  { dec: "29", oct: "035", hex: "1D", code: "GS", desc: t('tools.ascii.codes.29') },
  { dec: "30", oct: "036", hex: "1E", code: "RS", desc: t('tools.ascii.codes.30') },
  { dec: "31", oct: "037", hex: "1F", code: "US", desc: t('tools.ascii.codes.31') }
])

const tableDataStandard = computed(() => [
  { dec: "32", oct: "040", hex: "20", code: "Space", desc: t('tools.ascii.codes.32') },
  ...
  { dec: "127", oct: "177", hex: "7F", code: "DEL", desc: t('tools.ascii.codes.127') }
])

const tableDataNonStandard = computed(() => [
  ...
  { dec: "160", oct: "240", hex: "A0", code: " ", desc: t('tools.ascii.codes.160') },
  ...
  <div class="flex flex-col mt-3 flex-1">
    ...
    <div class="p-4 rounded-2xl bg-white">
      <el-table :data="tableDataControlCodes" class="w-full">
        <el-table-column :label="$t('tools.ascii.group_control')" align="center">
          <el-table-column prop="dec" :label="$t('tools.ascii.col_dec')" width="120" />
          <el-table-column prop="oct" :label="$t('tools.ascii.col_oct')" width="120" />
          <el-table-column prop="hex" :label="$t('tools.ascii.col_hex')" width="120" />
          <el-table-column prop="code" :label="$t('tools.ascii.col_sym')" width="120" />
          <el-table-column prop="desc" :label="$t('tools.ascii.col_desc')" />
        </el-table-column>
      </el-table>

      <el-table :data="tableDataStandard" class="w-full mt-3">
        <el-table-column :label="$t('tools.ascii.group_standard')" align="center">
          <el-table-column prop="dec" :label="$t('tools.ascii.col_dec')" width="120" />
          <el-table-column prop="oct" :label="$t('tools.ascii.col_oct')" width="120" />
          <el-table-column prop="hex" :label="$t('tools.ascii.col_hex')" width="120" />
          <el-table-column prop="code" :label="$t('tools.ascii.col_sym')" width="120" />
      ...
      <el-table :data="tableDataNonStandard" class="w-full mt-3">
        <el-table-column :label="$t('tools.ascii.group_extended')" align="center">
          <el-table-column prop="dec" :label="$t('tools.ascii.col_dec')" width="120" />
          <el-table-column prop="oct" :label="$t('tools.ascii.col_oct')" width="120" />
          <el-table-column prop="hex" :label="$t('tools.ascii.col_hex')" width="120" />
          <el-table-column prop="code" :label="$t('tools.ascii.col_sym')" width="120" />
    ...
    <!-- desc -->
    <ToolDetail :title="$t('tools.ascii.col_desc')">
      <el-text>
        {{ $t('tools.ascii.detail_content') }}
      </el-text> 
    </ToolDetail>
